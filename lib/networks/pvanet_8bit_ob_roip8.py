...
class pvanet_8bit_ob_roip8(Network):
	...
	def create_layer_map(self):
		...
		self._layer_map[68]={'name':'convf_up2',		'inputs':[67],				'fl':8, 'fl_w':16,'type':'conv'}	# TODO: fl and fl_w values
	...
	def setup(self):
		...
		(self.feed('data')
			 ...
			 .conv(4,4,32,2,2,name='conv1', fl=6, padding='VALID', rs=11)
			 .pad(1,name='conv2_pad')
			 .conv(3,3,48,2,2,name='conv2', fl=6, padding='VALID', rs=8)
			 .pad(1,name='conv3_pad')
			 .conv(3,3,96,2,2,name='conv3', fl=6, padding='VALID', rs=9))

		# Inception 3a ~~
		(self.feed('conv3')
			 .pad_v1(1,1,name='inc31fpool1/pad')
			 .max_pool(3,3,2,2,name='inc3a/pool1',padding='VALID')
			 .conv(1,1,96,1,1,name='inc3a/conv1', fl=6, padding='VALID', rs=7))
		(self.feed('conv3')
			 .conv(1,1,16,1,1,name='inc3a/conv3_1', fl=6, padding='VALID', rs=7)
			 .pad(1,name='inc3a/conv3_2_pad')
			 .conv(3,3,64,2,2,name='inc3a/conv3_2', fl=6, padding='VALID', rs=9))
		(self.feed('conv3')
			 .conv(1,1,16,1,1,name='inc3a/conv5_1', fl=6, padding='VALID', rs=7)
			 .pad(1,name='inc3a/conv5_2_pad')
			 .conv(3,3,32,1,1,name='inc3a/conv5_2', fl=6, padding='VALID', rs=8)
			 .pad(1,name='inc3a/conv5_3_pad')
			 .conv(3,3,32,2,2,name='inc3a/conv5_3', fl=6, padding='VALID', rs=8))
		(self.feed('inc3a/conv1', 'inc3a/conv3_2','inc3a/conv5_3')
			 .concat(axis=-1,name='inc3a'))

		# Inception 3b ~~ !
		(self.feed('inc3a')
			 .conv(1,1,96,1,1,name='inc3b/conv1', fl=6, padding='VALID', rs=8))
		(self.feed('inc3a')
			 .conv(1,1,16,1,1,name='inc3b/conv3_1', fl=6, padding='VALID', rs=10)
			 .pad(1,name='inc3b/conv3_2_pad')
			 .conv(3,3,64,1,1,name='inc3b/conv3_2', fl=6, padding='VALID', rs=8))
		(self.feed('inc3a')
			 .conv(1,1,16,1,1,name='inc3b/conv5_1', fl=6, padding='VALID', rs=8)
			 .pad(1,name='inc3b/conv5_2_pad')
			 .conv(3,3,32,1,1,name='inc3b/conv5_2', fl=6, padding='VALID', rs=8)
			 .pad(1,name='inc3b/conv5_3_pad')
			 .conv(3,3,32,1,1,name='inc3b/conv5_3', fl=6, padding='VALID', rs=10))
		(self.feed('inc3b/conv1', 'inc3b/conv3_2','inc3b/conv5_3')
			 .concat(axis=-1,name='inc3b'))

		# Inception 3c ~~ !
		(self.feed('inc3b')
			 .conv(1,1,96,1,1,name='inc3c/conv1', fl=6, padding='VALID', rs=8))
		(self.feed('inc3b')
			 .conv(1,1,16,1,1,name='inc3c/conv3_1', fl=6, padding='VALID', rs=8)
			 .pad(1,name='inc3c/conv3_2_pad')
			 .conv(3,3,64,1,1,name='inc3c/conv3_2', fl=6, padding='VALID', rs=8))
		(self.feed('inc3b')
			 .conv(1,1,16,1,1,name='inc3c/conv5_1', fl=6, padding='VALID', rs=8)
			 .pad(1,name='inc3cfconv5_2_pad')
			 .conv(3,3,32,1,1,name='inc3c/conv5_2', fl=6, padding='VALID', rs=7)
			 .pad(1,name='inc3c/conv5_3_pad')
			 .conv(3,3,32,1,1,name='inc3c/conv5_3', fl=6, padding='VALID', rs=10))
		(self.feed('inc3c/conv1', 'inc3c/conv3_2','inc3c/conv5_3')
			 .concat(axis=-1,name='inc3c'))

		# Inception 3d ~~ !
		(self.feed('inc3c')
			 .conv(1,1,96,1,1,name='inc3d/conv1', fl=6, padding='VALID', rs=8))
		(self.feed('inc3c')
			 .conv(1,1,16,1,1,name='inc3d/conv3_1', fl=6, padding='VALID', rs=9)
			 .pad(1,name='inc3d/conv3_3_pad')
			 .conv(3,3,64,1,1,name='inc3d/conv3_2', fl=6, padding='VALID', rs=8))
		(self.feed('inc3c')
			 .conv(1,1,16,1,1,name='inc3d/conv5_1', fl=6, padding='VALID', rs=9)
			 .pad(1,name='inc3d/conv5_3_pad')
			 .conv(3,3,32,1,1,name='inc3d/conv5_2', fl=6, padding='VALID', rs=7)
			 .pad(1,name='inc3d/conv5_3_pad')
			 .conv(3,3,32,1,1,name='inc3d/conv5_3', fl=6, padding='VALID', rs=9))
		(self.feed('inc3d/conv1', 'inc3d/conv3_2','inc3d/conv5_3')
			 .concat(axis=-1,name='inc3d'))

		# Inception 3e ~~ !
		(self.feed('inc3d')
			 .conv(1,1,96,1,1,name='inc3e/conv1', fl=6, padding='VALID', rs=8))
		(self.feed('inc3d')
			 .conv(1,1,16,1,1,name='inc3e/conv3_1', fl=6, padding='VALID', rs=8)
			 .pad(1,name='inc3e/conv3_2_pad')
			 .conv(3,3,64,1,1,name='inc3e/conv3_2', fl=6, padding='VALID', rs=8))
		(self.feed('inc3d')
			 .conv(1,1,16,1,1,name='inc3e/conv5_1', fl=6, padding='VALID', rs=9)
			 .pad(1,name='inc3e/conv5_2_pad')
			 .conv(3,3,32,1,1,name='inc3e/conv5_2', fl=6, padding='VALID', rs=7)
			 .pad(1,name='inc3e/conv5_3_pad')
			 .conv(3,3,32,1,1,name='inc3e/conv5_3', fl=6, padding='VALID', rs=8))
		...
		(self.feed('inc3e')
			 ...
			 .conv(1,1,128,1,1,name='inc4a/conv1', fl=6, padding='VALID', rs=9))
		(self.feed('inc3e')
			 .conv(1,1,32,1,1,name='inc4a/conv3_1', fl=6, padding='VALID', rs=9)
			 .pad(2,name='inc4a/conv3_2_pad')
			 .conv(5,5,96,1,1,name='inc4a/conv3_2', fl=6, padding='VALID', rs=7))
		(self.feed('inc3e')
			 .conv(1,1,16,1,1,name='inc4a/conv5_1', fl=6, padding='VALID', rs=8)
			 .pad(2,name='inc4a/conv5_2_pad')
			 .conv(5,5,32,1,1,name='inc4a/conv5_2', fl=6, padding='VALID', rs=8)
			 .pad(2,name='inc4a/conv5_3_pad')
			 .conv(5,5,32,1,1,name='inc4a/conv5_3', fl=6, padding='VALID', rs=9))
		(self.feed('inc4a/conv1', 'inc4a/conv3_2','inc4a/conv5_3')
			 .concat(axis=-1,name='inc4a'))

		# Inception 4b ~~
		(self.feed('inc4a')
			 .conv(1,1,128,1,1,name='inc4b/conv1', fl=6, padding='VALID', rs=10))
		(self.feed('inc4a')
			 .conv(1,1,32,1,1,name='inc4b/conv3_1', fl=6, padding='VALID', rs=9)
			 .pad(2,name='inc4b/conv3_2_pad')
			 .conv(5,5,96,1,1,name='inc4b/conv3_2', fl=6, padding='VALID', rs=9))
		(self.feed('inc4a')
			 .conv(1,1,16,1,1,name='inc4b/conv5_1', fl=6, padding='VALID', rs=8)
			 .pad(2,name='inc4b/conv5_2_pad')
			 .conv(5,5,32,1,1,name='inc4b/conv5_2', fl=6, padding='VALID', rs=9)
			 .pad(2,name='inc4b/conv5_3_pad')
			 .conv(5,5,32,1,1,name='inc4b/conv5_3', fl=6, padding='VALID', rs=9))
		(self.feed('inc4b/conv1', 'inc4b/conv3_2','inc4b/conv5_3')
			 .concat(axis=-1,name='inc4b'))

		# Inception 4c ~~
		(self.feed('inc4b')
			 .conv(1,1,128,1,1,name='inc4c/conv1', fl=6, padding='VALID', rs=8))
		(self.feed('inc4b')
			 .conv(1,1,32,1,1,name='inc4c/conv3_1', fl=6, padding='VALID', rs=8)
			 .pad(2,name='inc4c/conv3_2_pad')
			 .conv(5,5,96,1,1,name='inc4c/conv3_2', fl=6, padding='VALID', rs=8))
		(self.feed('inc4b')
			 .conv(1,1,16,1,1,name='inc4c/conv5_1', fl=6, padding='VALID', rs=7)
			 .pad(2,name='inc4c/conv5_2_pad')
			 .conv(5,5,32,1,1,name='inc4c/conv5_2', fl=6, padding='VALID', rs=9)
			 .pad(2,name='inc4c/conv5_3_pad')
			 .conv(5,5,32,1,1,name='inc4c/conv5_3', fl=6, padding='VALID', rs=9))
		(self.feed('inc4c/conv1', 'inc4c/conv3_2','inc4c/conv5_3')
			 .concat(axis=-1,name='inc4c'))

		# Inception 4d ~~
		(self.feed('inc4c')
			 .conv(1,1,128,1,1,name='inc4d/conv1', fl=6, padding='VALID', rs=8))
		(self.feed('inc4c')
			 .conv(1,1,32,1,1,name='inc4d/conv3_1', fl=6, padding='VALID', rs=8)
			 .pad(2,name='inc4d/conv3_2_pad')
			 .conv(5,5,96,1,1,name='inc4d/conv3_2', fl=6, padding='VALID', rs=8))
		(self.feed('inc4c')
			 .conv(1,1,16,1,1,name='inc4d/conv5_1', fl=6, padding='VALID', rs=8)
			 .pad(2,name='inc4d/conv5_2_pad')
			 .conv(5,5,32,1,1,name='inc4d/conv5_2', fl=6, padding='VALID', rs=8)
			 .pad(2,name='inc4d/conv5_3_pad')
			 .conv(5,5,32,1,1,name='inc4d/conv5_3', fl=6, padding='VALID', rs=8))
		(self.feed('inc4d/conv1', 'inc4d/conv3_2','inc4d/conv5_3')
			 .concat(axis=-1,name='inc4d'))

		# Inception 4e ~~
		(self.feed('inc4d')
			 .conv(1,1,128,1,1,name='inc4e/conv1', fl=6, padding='VALID', rs=7))
		(self.feed('inc4d')
			 .conv(1,1,32,1,1,name='inc4e/conv3_1', fl=6, padding='VALID', rs=8)
			 .pad(2,name='inc4e/conv3_2_pad')
			 .conv(5,5,96,1,1,name='inc4e/conv3_2', fl=6, padding='VALID', rs=7))
		(self.feed('inc4d')
			 .conv(1,1,16,1,1,name='inc4e/conv5_1', fl=6, padding='VALID', rs=9)
			 .pad(2,name='inc4e/conv5_2_pad')
			 .conv(5,5,32,1,1,name='inc4e/conv5_2', fl=6, padding='VALID', rs=8)
			 .pad(2,name='inc4e/conv5_3_pad')
			 .conv(5,5,32,1,1,name='inc4e/conv5_3', fl=6, padding='VALID', rs=8))
		...
		(self.feed('downsample','inc3e','inc4e',)
			 ...
			 .conv(1,1,256,1,1,name='convf', fl=8 ,padding='VALID', rs=9)
			 .upconv(shape=[1,150,240,256], c_o=256, name='convf_up2', ksize=4, stride=2, biased=False, relu=False, padding='SAME'))	# Deconv layer !!! 	

		(self.feed('convf')
			 .conv(1,1,256,1,1,name='rpn_conv1', fl=10, padding='VALID', rs=8)
			 .conv(1,1,98,1,1,name='rpn_cls_score_fabu', relu=False, fl=10, padding='VALID', rs=8)
			 .dummy(name='rpn_cls_prob_reshape'))

		(self.feed('rpn_conv1')
			 .conv(1,1,196,1,1,name='rpn_bbox_pred_fabu',relu=False, fl=13, padding='VALID', rs=7))
		...
		(self.feed('convf_up2','proposal')
			 ...
			 .fc(512,name='fc6_L', fl=6, relu=False, rs=7)
			 .fc(4096,name='fc6_U', fl=7, rs=8)
			 .fc(128,name='fc7_L',fl=7, relu=False, rs=9)
		  	 .fc(4096,name='fc7_U', fl=9, rs=9)
			 .fc(32,name='bbox_pred_fabu',fl=9 ,relu=False, rs=9))

		(self.feed('fc7_U')
			 .fc(8,name='cls_score_fabu',fl=9, relu=False, rs=12)
