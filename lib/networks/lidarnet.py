...
class LIDAR(Network):
    ...
    def create_layer_map(self):
        ...
        #.............
        self._layer_map[19]= {'name':'resnetv1pyr1_stage_4bottleneckv12__plus0', 'inputs':[15,18],              'fl':3,    'fl_y':2,         'type':'add'} 
        self._layer_map[20]= {'name':'resnetv1pyr1_stage_4bottleneckv12_relu2_fwd', 'inputs':[19],  'type':'relu'} 
        self._layer_map[21]= {'name':'resnetv1pyr1_stage_8bottleneckv10_hybridsequential0_conv0_fwd',   'inputs':[20],        'fl_w': 9, 'fl':2, 'fl_y':3, 'rs':8, 'type':'conv'} 
        ...
        #.............
        self._layer_map[24]= {'name':'resnetv1pyr1_stage_8_shortcutpool0_fwd',   'inputs':[20], 'fl':2, 'fl_y':2, 'type':'avg_pool'} 
        self._layer_map[25]= {'name':'resnetv1pyr1_stage_8_shortcuthybridsequential0_conv0_fwd',   'inputs':[24],        'fl_w': 8, 'fl':2, 'fl_y':3, 'rs':7, 'type':'conv'} 
        ...
        #..............
        self._layer_map[31]= {'name':'resnetv1pyr1_stage_8bottleneckv11__plus0', 'inputs':[27,30],               'fl':3,    'fl_y':2,        'type':'add'} 
        ...
        #............
        self._layer_map[41]= {'name':'resnetv1pyr1_stage_8bottleneckv13__plus0', 'inputs':[37,40],              'fl':3,    'fl_y':2,         'type':'add'} 
        self._layer_map[42]= {'name':'resnetv1pyr1_stage_8bottleneckv13_relu2_fwd', 'inputs':[41],  'type':'relu'} 
        self._layer_map[43]= {'name':'resnetv1pyr1_hybridsequential6_conv0_fwd',   'inputs':[42],        'fl_w': 10, 'fl':2, 'fl_y':3, 'rs':9, 'type':'conv'} 
  

        #.............
        self._layer_map[44]= {'name':'resnetv1pyr1_stage_16bottleneckv10_hybridsequential0_conv0_fwd', 'inputs':[42],           'fl_w': 10, 'fl':2, 'fl_y':3, 'rs':9, 'type':'conv'} 
        ...
        #.............
        self._layer_map[47]= {'name':'resnetv1pyr1_stage_16_shortcutpool0_fwd',   'inputs':[42],  'fl':2, 'fl_y':2, 'type':'avg_pool'} 
        self._layer_map[48]= {'name':'resnetv1pyr1_stage_16_shortcuthybridsequential0_conv0_fwd',   'inputs':[47],        'fl_w': 9, 'fl':2, 'fl_y':4, 'rs':7, 'type':'conv'} 

        #..............
        self._layer_map[49]= {'name':'resnetv1pyr1_stage_16bottleneckv10__plus0', 'inputs':[46,48],              'fl':4,    'fl_y':3,         'type':'add'} 
        self._layer_map[50]= {'name':'resnetv1pyr1_stage_16bottleneckv10_relu2_fwd', 'inputs':[49],  'type':'relu'} 
        self._layer_map[51]= {'name':'resnetv1pyr1_stage_16bottleneckv11_hybridsequential0_conv0_fwd',   'inputs':[50],        'fl_w': 10, 'fl':3, 'fl_y':3, 'rs':10, 'type':'conv'} 
        ...
        self._layer_map[53]= {'name':'resnetv1pyr1_stage_16bottleneckv11_hybridsequential2_conv0_fwd',   'inputs':[52],        'fl_w': 8, 'fl':4, 'fl_y':3, 'rs':9,   'type':'conv'} 


        #................
        self._layer_map[54]= {'name':'resnetv1pyr1_stage_16bottleneckv11__plus0', 'inputs':[50,53],              'fl':3,    'fl_y':3,         'type':'add'} 
        self._layer_map[55]= {'name':'resnetv1pyr1_stage_16bottleneckv11_relu2_fwd', 'inputs':[54],  'type':'relu'} 
        self._layer_map[56]= {'name':'resnetv1pyr1_stage_16bottleneckv12_hybridsequential0_conv0_fwd',   'inputs':[55],        'fl_w': 10, 'fl':3, 'fl_y':3, 'rs':10, 'type':'conv'} 
        ...
        self._layer_map[58]= {'name':'resnetv1pyr1_stage_16bottleneckv12_hybridsequential2_conv0_fwd',   'inputs':[57],        'fl_w': 8, 'fl':3, 'fl_y':3, 'rs':8,   'type':'conv'} 

        #.........
        self._layer_map[59]= {'name':'resnetv1pyr1_stage_16bottleneckv12__plus0', 'inputs':[55,58],              'fl':3,    'fl_y':3,         'type':'add'} 
        self._layer_map[60]= {'name':'resnetv1pyr1_stage_16bottleneckv12_relu2_fwd', 'inputs':[59],  'type':'relu'} 
        self._layer_map[61]= {'name':'resnetv1pyr1_hybridsequential4_conv0_fwd',   'inputs':[60],        'fl_w': 11, 'fl':3, 'fl_y':4, 'rs':10, 'type':'conv'} 
   

        #.................
        self._layer_map[62]= {'name':'resnetv1pyr1_stage_16_dbottleneckv10_hybridsequential0_conv0_fwd',   'inputs':[60],        'fl_w': 10, 'fl':3, 'fl_y':3, 'rs':10, 'type':'conv'} 
        ...
        #...............
        self._layer_map[65]= {'name':'resnetv1pyr1_stage_16_d_shortcuthybridsequential0_conv0_fwd',   'inputs':[60],            'fl_w': 10, 'fl':3, 'fl_y':4, 'rs':9,   'type':'conv'} 
        ...
        #..................
        self._layer_map[76]= {'name':'resnetv1pyr1_stage_16_dbottleneckv12__plus0',     'inputs':[72,75],              'fl':4,    'fl_y':3,         'type':'add'} 
        self._layer_map[77]= {'name':'resnetv1pyr1_stage_16_dbottleneckv12_relu2_fwd',  'inputs':[76],  'type':'relu'} 
        self._layer_map[78]= {'name':'resnetv1pyr1_hybridsequential3_conv0_fwd',         'inputs':[77], 'fl_w': 10, 'fl':3, 'fl_y':4, 'rs':9, 'type':'conv'} 
   
        #..................
        self._layer_map[79]= {'name':'resnetv1pyr1__plus0',                       'inputs':[61,78],                'fl':4,    'fl_y':3,           'type':'add'} 
        self._layer_map[80]= {'name':'resnetv1pyr1_hybridsequential5_conv0_fwd',  'inputs':[79],        'fl_w': 12, 'fl':3, 'fl_y':3, 'rs':12, 'type':'conv'} 
        self._layer_map[81]= {'name':'resnetv1pyr1_upsampling0',                  'inputs':[80],        'fl_w': 0, 'fl':3, 'fl_y':3, 'rs':0, 'type':'deconv'}  # TODO
        
        #..................
        self._layer_map[82]= {'name':'resnetv1pyr1__plus1',                       'inputs':[43,81],                'fl':3,    'fl_y':2,           'type':'add'} 
        self._layer_map[83]= {'name':'resnetv1pyr1_hybridsequential7_conv0_fwd',  'inputs':[82],        'fl_w': 13, 'fl':2, 'fl_y':3, 'rs':12, 'type':'conv'} 
        self._layer_map[84]= {'name':'resnetv1pyr1_upsampling1',                  'inputs':[83],        'fl_w': 0, 'fl':3, 'fl_y':3, 'rs':0, 'type':'deconv'}     #TODO
   
        #..................
        self._layer_map[85]= {'name':'resnetv1pyr1_hybridsequential8_conv0_fwd',            'inputs':[20],        'fl_w': 10, 'fl':2, 'fl_y':3, 'rs':9, 'type':'conv'}   
        ...
        #............output........
        self._layer_map[96]= {'name':'resnetv1pyr1_share_head_16hybridsequential0_conv0_fwd',   'inputs':[80],      'fl_w': 9, 'fl':3, 'fl_y':1, 'rs':11,   'type':'conv'} 
    ...
    def setup(self):
        ...
        (self.feed('resnetv1pyr1_stage_4bottleneckv12_hybridsequential2_conv0_fwd', 
             ...
             .add(name='resnetv1pyr1_stage_4bottleneckv12__plus0',fl=3,fl_y=2)
             .relu(name='resnetv1pyr1_stage_4bottleneckv12_relu2_fwd')
             .conv(1, 1, 128, 2, 2, name='resnetv1pyr1_stage_8bottleneckv10_hybridsequential0_conv0_fwd',fl_w=9,fl=2,fl_y=3,rs=8)
        ...
        (self.feed('resnetv1pyr1_stage_4bottleneckv12_relu2_fwd')
             .avg_pool(2, 2, 2, 2, name='resnetv1pyr1_stage_8_shortcutpool0_fwd',fl=2,fl_y=2)
             .conv(1, 1, 512, 1, 1, relu=False, name='resnetv1pyr1_stage_8_shortcuthybridsequential0_conv0_fwd',fl_w=8,fl=2,fl_y=3,rs=7))
        ...
        (self.feed('resnetv1pyr1_stage_8bottleneckv13_hybridsequential2_conv0_fwd', 
             ...
             .add(name='resnetv1pyr1_stage_8bottleneckv13__plus0',fl=3,fl_y=2)
             .relu(name='resnetv1pyr1_stage_8bottleneckv13_relu2_fwd')
             .conv(1, 1, 128, 1, 1, relu=False, name='resnetv1pyr1_hybridsequential6_conv0_fwd',fl_w=10,fl=2,fl_y=3,rs=9))

        (self.feed('resnetv1pyr1_stage_8bottleneckv13_relu2_fwd')
             .conv(1, 1, 256, 2, 2, name='resnetv1pyr1_stage_16bottleneckv10_hybridsequential0_conv0_fwd',fl_w=10,fl=2,fl_y=3,rs=9)
        ...
        (self.feed('resnetv1pyr1_stage_8bottleneckv13_relu2_fwd')
             .avg_pool(2, 2, 2, 2, name='resnetv1pyr1_stage_16_shortcutpool0_fwd',fl=2,fl_y=2)
             .conv(1, 1, 1024, 1, 1, relu=False, name='resnetv1pyr1_stage_16_shortcuthybridsequential0_conv0_fwd',fl_w=9,fl=2,fl_y=4,rs=7))
        ...
        (self.feed('resnetv1pyr1_stage_16bottleneckv10_hybridsequential2_conv0_fwd', 
             ...
             .add(name='resnetv1pyr1_stage_16bottleneckv10__plus0',fl=4,fl_y=3)
             .relu(name='resnetv1pyr1_stage_16bottleneckv10_relu2_fwd')
             .conv(1, 1, 128, 1, 1, name='resnetv1pyr1_stage_16bottleneckv11_hybridsequential0_conv0_fwd',fl_w=10,fl=3,fl_y=3,rs=10)
             .conv(3, 3, 128, 1, 1, name='resnetv1pyr1_stage_16bottleneckv11_hybridsequential1_conv0_fwd',fl_w=10,fl=3,fl_y=4,rs=9)
             .conv(1, 1, 1024, 1, 1, relu=False, name='resnetv1pyr1_stage_16bottleneckv11_hybridsequential2_conv0_fwd',fl_w=8,fl=4,fl_y=3,rs=9))

        (self.feed('resnetv1pyr1_stage_16bottleneckv11_hybridsequential2_conv0_fwd', 
                   'resnetv1pyr1_stage_16bottleneckv10_relu2_fwd')
             .add(name='resnetv1pyr1_stage_16bottleneckv11__plus0',fl=3,fl_y=3)
             .relu(name='resnetv1pyr1_stage_16bottleneckv11_relu2_fwd')
             .conv(1, 1, 128, 1, 1, name='resnetv1pyr1_stage_16bottleneckv12_hybridsequential0_conv0_fwd',fl_w=10,fl=3,fl_y=3,rs=10)
             .conv(3, 3, 128, 1, 1, name='resnetv1pyr1_stage_16bottleneckv12_hybridsequential1_conv0_fwd',fl_w=10,fl=3,fl_y=3,rs=10)
             .conv(1, 1, 1024, 1, 1, relu=False, name='resnetv1pyr1_stage_16bottleneckv12_hybridsequential2_conv0_fwd',fl_w=8,fl=3,fl_y=3,rs=8))


        (self.feed('resnetv1pyr1_stage_16bottleneckv12_hybridsequential2_conv0_fwd', 
                   'resnetv1pyr1_stage_16bottleneckv11_relu2_fwd')
             .add(name='resnetv1pyr1_stage_16bottleneckv12__plus0',fl=3,fl_y=3)
             .relu(name='resnetv1pyr1_stage_16bottleneckv12_relu2_fwd')
             .conv(1, 1, 256, 1, 1, relu=False, name='resnetv1pyr1_hybridsequential4_conv0_fwd',fl_w=11,fl=3,fl_y=4,rs=10))

        (self.feed('resnetv1pyr1_stage_16bottleneckv12_relu2_fwd')
             .conv(1, 1, 128, 1, 1, name='resnetv1pyr1_stage_16_dbottleneckv10_hybridsequential0_conv0_fwd',fl_w=10,fl=3,fl_y=3,rs=10)
             .conv(3, 3, 128, 1, 1, name='resnetv1pyr1_stage_16_dbottleneckv10_hybridsequential1_conv0_fwd',fl_w=9,fl=3,fl_y=4,rs=8,rate=2)
        ...
        (self.feed('resnetv1pyr1_stage_16bottleneckv12_relu2_fwd')
             .conv(1, 1, 1024, 1, 1, relu=False, name='resnetv1pyr1_stage_16_d_shortcuthybridsequential0_conv0_fwd',fl_w=10,fl=3,fl_y=4,rs=9))
        ...
        (self.feed('resnetv1pyr1_stage_16_dbottleneckv10_hybridsequential2_conv0_fwd', 
             ...
             .conv(3, 3, 128, 1, 1, name='resnetv1pyr1_stage_16_dbottleneckv11_hybridsequential1_conv0_fwd',fl_w=9,fl=3,fl_y=4,rs=8,rate=2)
        ...
        (self.feed('resnetv1pyr1_stage_16_dbottleneckv11_hybridsequential2_conv0_fwd', 
             ...
             .conv(3, 3, 128, 1, 1,  name='resnetv1pyr1_stage_16_dbottleneckv12_hybridsequential1_conv0_fwd',fl_w=9,fl=3,fl_y=3,rs=9,rate=2)
        ...
        (self.feed('resnetv1pyr1_stage_16_dbottleneckv12_hybridsequential2_conv0_fwd', 
             ...
             .add(name='resnetv1pyr1_stage_16_dbottleneckv12__plus0',fl=4,fl_y=3)
             .relu(name='resnetv1pyr1_stage_16_dbottleneckv12_relu2_fwd')
             .conv(1, 1, 256, 1, 1, relu=False, name='resnetv1pyr1_hybridsequential3_conv0_fwd',fl_w=10,fl=3,fl_y=4,rs=9))

        (self.feed('resnetv1pyr1_hybridsequential4_conv0_fwd', 
                   'resnetv1pyr1_hybridsequential3_conv0_fwd')
             .add(name='resnetv1pyr1__plus0',fl=4,fl_y=3)
             .conv(3, 3, 128, 1, 1, relu=False, name='resnetv1pyr1_hybridsequential5_conv0_fwd',fl_w=12,fl=3,fl_y=3,rs=12)
        ...
        (self.feed('resnetv1pyr1_hybridsequential6_conv0_fwd', 
             ...
             .add(name='resnetv1pyr1__plus1',fl=3,fl_y=2)
             .conv(3, 3, 64, 1, 1, relu=False, name='resnetv1pyr1_hybridsequential7_conv0_fwd',fl_w=13,fl=2,fl_y=3,rs=12)
             .deconv(2, 2, 64, 2, 2, relu=False, name='resnetv1pyr1_upsampling1',fl_w=0,fl=3,fl_y=3,rs=0))         #TODO X=3,Y=3

        (self.feed('resnetv1pyr1_stage_4bottleneckv12_relu2_fwd')
             .conv(1, 1, 64, 1, 1, relu=False, name='resnetv1pyr1_hybridsequential8_conv0_fwd',fl_w=10,fl=2,fl_y=3,rs=9))
