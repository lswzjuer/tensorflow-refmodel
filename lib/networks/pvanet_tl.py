...
class pvanet_tl(Network):
	def __init__(self, isHardware=True, trainable=False):
		...
		self.classes = ("BG", "11", "12", "13", "14", "15", "16", "17","21", "22", "23", "24", "25", "26", "27", "31")
		self._layer_map = {}
	...
	def _get_image_blob(self, im, im_dim):
		...
		width = 1400;
		height = 800;
		im_info = [640, 1056, (1056/1.0)/1400,(640/1.0)/800, (1056/1.0)/1400, (640/1.0)/800]
	...
	def create_layer_map(self):
		...
		self._layer_map[0]={'name':'data',					'inputs':[],  						'fl':7} 
		self._layer_map[1]={'name':'conv1',					'inputs':[0], 						'fl':6, 'fl_w':17}
		self._layer_map[2]={'name':'conv2',					'inputs':[1], 						'fl':6, 'fl_w':14}
		self._layer_map[3]={'name':'conv3',					'inputs':[2], 						'fl':6, 'fl_w':16}
		# Inception 3a ~~~~~~~~~~~~~~~~~~~~~~~~
		self._layer_map[4]={'name':'inc3a/pool1',			'inputs':[3], 						'fl':6}
		self._layer_map[5]={'name':'inc3a/conv1',			'inputs':[4], 						'fl':6, 'fl_w':15}
		self._layer_map[6]={'name':'inc3a/conv3_1',			'inputs':[3], 						'fl':6, 'fl_w':14}
		self._layer_map[7]={'name':'inc3a/conv3_2',			'inputs':[6], 						'fl':6, 'fl_w':15}
		self._layer_map[8]={'name':'inc3a/conv5_1',			'inputs':[3], 						'fl':6, 'fl_w':14}
		self._layer_map[9]={'name':'inc3a/conv5_2',			'inputs':[8], 						'fl':6, 'fl_w':15}
		self._layer_map[10]={'name':'inc3a/conv5_3',		'inputs':[9], 						'fl':6, 'fl_w':15}
		# Inception 3b ~~~~~~~~~~~~~~~~~~~~~~~~
		self._layer_map[11]={'name':'inc3b/conv1',			'inputs':[5,7,10], 					'fl':6, 'fl_w':14}
		self._layer_map[12]={'name':'inc3b/conv3_1',		'inputs':[5,7,10], 					'fl':6, 'fl_w':14}
		self._layer_map[13]={'name':'inc3b/conv3_2',		'inputs':[12], 						'fl':6, 'fl_w':15}
		self._layer_map[14]={'name':'inc3b/conv5_1',		'inputs':[5,7,10], 					'fl':6, 'fl_w':15}
		self._layer_map[15]={'name':'inc3b/conv5_2',		'inputs':[14], 						'fl':6, 'fl_w':14}
		self._layer_map[16]={'name':'inc3b/conv5_3',		'inputs':[15], 						'fl':6, 'fl_w':15}
		# Inception 3c ~~~~~~~~~~~~~~~~~~~~~~~~
		self._layer_map[17]={'name':'inc3c/conv1',			'inputs':[11,13,16], 				'fl':6, 'fl_w':14}
		self._layer_map[18]={'name':'inc3c/conv3_1',		'inputs':[11,13,16], 				'fl':6, 'fl_w':15}
		self._layer_map[19]={'name':'inc3c/conv3_2',		'inputs':[18], 						'fl':6, 'fl_w':15}
		self._layer_map[20]={'name':'inc3c/conv5_1',		'inputs':[11,13,16], 				'fl':6, 'fl_w':14}
		self._layer_map[21]={'name':'inc3c/conv5_2',		'inputs':[20], 						'fl':6, 'fl_w':13}
		self._layer_map[22]={'name':'inc3c/conv5_3',		'inputs':[21], 						'fl':6, 'fl_w':15}
		# Inception 3d ~~~~~~~~~~~~~~~~~~~~~~~~
		self._layer_map[23]={'name':'inc3d/conv1',			'inputs':[17,19,22], 				'fl':6, 'fl_w':15}
		self._layer_map[24]={'name':'inc3d/conv3_1',		'inputs':[17,19,22], 				'fl':6, 'fl_w':14}
		self._layer_map[25]={'name':'inc3d/conv3_2',		'inputs':[24], 						'fl':6, 'fl_w':15}
		self._layer_map[26]={'name':'inc3d/conv5_1',		'inputs':[17,19,22], 				'fl':6, 'fl_w':15}
		self._layer_map[27]={'name':'inc3d/conv5_2',		'inputs':[26], 						'fl':6, 'fl_w':14}
		self._layer_map[28]={'name':'inc3d/conv5_3',		'inputs':[27], 						'fl':6, 'fl_w':16}
		# Inception 3e ~~~~~~~~~~~~~~~~~~~~~~~~
		self._layer_map[29]={'name':'inc3e/conv1',			'inputs':[23,25,28], 				'fl':6, 'fl_w':14}
		self._layer_map[30]={'name':'inc3e/conv3_1',		'inputs':[23,25,28], 				'fl':6, 'fl_w':15}
		self._layer_map[31]={'name':'inc3e/conv3_2',		'inputs':[30], 						'fl':6, 'fl_w':15}
		self._layer_map[32]={'name':'inc3e/conv5_1',		'inputs':[23,25,28], 				'fl':6, 'fl_w':15}
		self._layer_map[33]={'name':'inc3e/conv5_2',		'inputs':[32], 						'fl':6, 'fl_w':14}
		self._layer_map[34]={'name':'inc3e/conv5_3',		'inputs':[33], 						'fl':6, 'fl_w':15}
		# Inception 4a ~~~~~~~~~~~~~~~~~~~~~~~~
		self._layer_map[35]={'name':'inc4a/pool1',			'inputs':[29,31,34], 				'fl':6}
		self._layer_map[36]={'name':'inc4a/conv1',			'inputs':[35], 						'fl':6, 'fl_w':15}
		self._layer_map[37]={'name':'inc4a/conv3_1',		'inputs':[29,31,34], 				'fl':6, 'fl_w':15}
		self._layer_map[38]={'name':'inc4a/conv3_2',		'inputs':[37],	 					'fl':6, 'fl_w':15}
		self._layer_map[39]={'name':'inc4a/conv5_1',		'inputs':[29,31,34], 				'fl':6, 'fl_w':16}
		self._layer_map[40]={'name':'inc4a/conv5_2',		'inputs':[39], 						'fl':6, 'fl_w':15}
		self._layer_map[41]={'name':'inc4a/conv5_3',		'inputs':[40], 						'fl':6, 'fl_w':16}
		# Inception 4b ~~~~~~~~~~~~~~~~~~~~~~~~
		self._layer_map[42]={'name':'inc4b/conv1',			'inputs':[36,38,41], 				'fl':6, 'fl_w':15}
		self._layer_map[43]={'name':'inc4b/conv3_1',		'inputs':[36,38,41], 				'fl':6, 'fl_w':15}
		self._layer_map[44]={'name':'inc4b/conv3_2',		'inputs':[43], 						'fl':6, 'fl_w':15}
		self._layer_map[45]={'name':'inc4b/conv5_1',		'inputs':[36,38,41], 				'fl':6, 'fl_w':16}
		self._layer_map[46]={'name':'inc4b/conv5_2',		'inputs':[45], 						'fl':6, 'fl_w':15}
		self._layer_map[47]={'name':'inc4b/conv5_3',		'inputs':[46], 						'fl':6, 'fl_w':15}
		# Inception 4c ~~~~~~~~~~~~~~~~~~~~~~~~
		self._layer_map[48]={'name':'inc4c/conv1',			'inputs':[42,44,47], 				'fl':6, 'fl_w':15}
		self._layer_map[49]={'name':'inc4c/conv3_1',		'inputs':[42,44,47], 				'fl':6, 'fl_w':15}
		self._layer_map[50]={'name':'inc4c/conv3_2',		'inputs':[49], 						'fl':6, 'fl_w':15}
		self._layer_map[51]={'name':'inc4c/conv5_1',		'inputs':[42,44,47], 				'fl':6, 'fl_w':15}
		self._layer_map[52]={'name':'inc4c/conv5_2',		'inputs':[51], 						'fl':6, 'fl_w':15}
		self._layer_map[53]={'name':'inc4c/conv5_3',		'inputs':[52], 						'fl':6, 'fl_w':14}
		# Inception 4d ~~~~~~~~~~~~~~~~~~~~~~~~
		self._layer_map[54]={'name':'inc4d/conv1',			'inputs':[48,50,53], 				'fl':6, 'fl_w':15}
		self._layer_map[55]={'name':'inc4d/conv3_1',		'inputs':[48,50,53], 				'fl':6, 'fl_w':14}
		self._layer_map[56]={'name':'inc4d/conv3_2',		'inputs':[55], 						'fl':6, 'fl_w':15}
		self._layer_map[57]={'name':'inc4d/conv5_1',		'inputs':[48,50,53], 				'fl':6, 'fl_w':16}
		self._layer_map[58]={'name':'inc4d/conv5_2',		'inputs':[57], 						'fl':6, 'fl_w':15}
		self._layer_map[59]={'name':'inc4d/conv5_3',		'inputs':[58], 						'fl':6, 'fl_w':15}
		# Inception 4e ~~~~~~~~~~~~~~~~~~~~~~~~
		self._layer_map[60]={'name':'inc4e/conv1',			'inputs':[54,56,59], 				'fl':6, 'fl_w':15}
		self._layer_map[61]={'name':'inc4e/conv3_1',		'inputs':[54,56,59], 				'fl':6, 'fl_w':15}
		self._layer_map[62]={'name':'inc4e/conv3_2',		'inputs':[61], 						'fl':6, 'fl_w':15}
		self._layer_map[63]={'name':'inc4e/conv5_1',		'inputs':[54,56,59], 				'fl':6, 'fl_w':14}
		self._layer_map[64]={'name':'inc4e/conv5_2',		'inputs':[63], 						'fl':6, 'fl_w':14}
		self._layer_map[65]={'name':'inc4e/conv5_3',		'inputs':[64], 						'fl':6, 'fl_w':15}
		# Downsample ~~~~~~~~~~~~~~~~~~~~~~~~~~~
		self._layer_map[66]={'name':'downsample', 			'inputs':[3], 'fl':6}
		self._layer_map[67]={'name':'convf', 				'inputs':[66,29,31,34,60,62,65], 	'fl':8,  'fl_w':16}		# GARY
		self._layer_map[68]={'name':'rpn_conv1', 			'inputs':[67], 						'fl':10, 'fl_w':16}
		self._layer_map[69]={'name':'rpn_cls_score_fabu', 	'inputs':[68], 						'fl':10, 'fl_w':16}
		self._layer_map[70]={'name':'rpn_bbox_pred_fabu', 	'inputs':[68],						'fl':13, 'fl_w':18}
		self._layer_map[71]={'name':'proposal', 			'inputs':[69,70], 					'fl':4}					# GARY
		self._layer_map[72]={'name':'roi_pool_conv5', 		'inputs':[67,71], 					'fl':8}					# GARY
		self._layer_map[73]={'name':'fc6_L',				'inputs':[72], 						'fl':6, 'fl_w':17}
		self._layer_map[74]={'name':'fc6_U',			 	'inputs':[73], 						'fl':7, 'fl_w':17}
		self._layer_map[75]={'name':'fc7_L',			 	'inputs':[74], 						'fl':7, 'fl_w':17}
		self._layer_map[76]={'name':'fc7_U',			 	'inputs':[75], 						'fl':9, 'fl_w':17}
		self._layer_map[77]={'name':'cls_score_fabu',		'inputs':[76], 						'fl':9, 'fl_w':17}
		self._layer_map[78]={'name':'bbox_pred_fabu',		'inputs':[76], 						'fl':9, 'fl_w':17}
	...
	def setup(self):
		...
		(self.feed('data')
			 ...
			 .conv(3,3,96,1,1,name='conv3', fl=6, padding='VALID'))
		...
		(self.feed('inc4b')
			 ...
			 .conv(3,3,96,1,1,name='inc4c/conv3_2', fl=6, padding='VALID'))
		(self.feed('inc4b')
		...
		(self.feed('inc4d')
			 ...
			 .conv(3,3,96,1,1,name='inc4e/conv3_2', fl=6, padding='VALID'))
		(self.feed('inc4d')
		...
		(self.feed('convf')
			 ...
			 .conv(1,1,14,1,1,name='rpn_cls_score_fabu', relu=False, fl=10, padding='VALID')
			 .dummy(name='rpn_cls_prob_reshape'))

		(self.feed('rpn_conv1')
			 .conv(1,1,28,1,1,name='rpn_bbox_pred_fabu',relu=False, fl=13, padding='VALID'))
		...
		(self.feed('convf','proposal')
			 ...
			 .fc(64,name='bbox_pred_fabu',fl=9 ,relu=False))

		(self.feed('fc7_U')
			 .fc(16,name='cls_score_fabu',fl=9, relu=False)
