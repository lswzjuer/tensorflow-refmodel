...
class LIDAR(Network):
    ...
    def setup(self):
        ...
        (self.feed('resnetv1pyr1_stage_16bottleneckv12_relu2_fwd')
             ...
             .conv(3, 3, 128, 1, 1, name='resnetv1pyr1_stage_16_dbottleneckv10_hybridsequential1_conv0_fwd')
        ...
        (self.feed('resnetv1pyr1_stage_16_dbottleneckv10_hybridsequential2_conv0_fwd', 
             ...
             .conv(3, 3, 128, 1, 1, name='resnetv1pyr1_stage_16_dbottleneckv11_hybridsequential1_conv0_fwd')
        ...
        (self.feed('resnetv1pyr1_stage_16_dbottleneckv11_hybridsequential2_conv0_fwd', 
             ...
             .conv(3, 3, 128, 1, 1,  name='resnetv1pyr1_stage_16_dbottleneckv12_hybridsequential1_conv0_fwd')
